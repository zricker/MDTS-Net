...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--data_path', type=str, default='/home/po/Desktop/PDData/train/Control/', help='Train images path')          # 非帕金森樣本路徑
        parser.add_argument('--parkinson_data_path', type=str, default='/home/po/Desktop/PDData/train/PD/', help='Train images path')# 帕金森樣本路徑
        parser.add_argument('--val_path', type=str, default='/home/po/Desktop/PDData/test/Control/', help='Validation images path')
        ...
        parser.add_argument('--gpu_ids', default='0,1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints_new_decay_method', help='models are saved here')
