...
parser.add_argument('--images', default='/home/po/Desktop/bad/bad/images', help='path to the images a (early frames)')
parser.add_argument('--labels', default='/home/po/Desktop/bad/bad/labels', help='path to the images b (late frames)')
parser.add_argument('--split', default=0, help='number of images for testing')
parser.add_argument('--resolution', default=(2.5, 2.5, 2.0), help='new resolution to resample the all data')
...
if __name__ == "__main__":
    ...
    if not os.path.isdir('/home/po/Desktop/bad/new/train'):
        os.mkdir('/home/po/Desktop/bad/new/train')

    if not os.path.isdir('/home/po/Desktop/bad/new/test'):
        os.mkdir('/home/po/Desktop/bad/new/test')

    for i in range(len(list_images)-int(args.split)):

        save_directory_images = '/home/po/Desktop/bad/new/train/images'
        save_directory_labels = '/home/po/Desktop/bad/new/train/labels'
        ...
        sitk.WriteImage(image[:, :, 20:60], image_directory)
        sitk.WriteImage(label[:, :, 20:60], label_directory)
